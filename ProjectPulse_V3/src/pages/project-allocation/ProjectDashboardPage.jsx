              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 4, paddingTop: 10, borderTop: `1px solid ${COLORS.border}` }}>
                ...
                <div style={{ display: "flex", gap: 6 }} onClick={(e) => e.stopPropagation()}>
                  ...
                  <button
                    ...
                    disabled={!isDeletable(p)}
                    title={!isDeletable(p) ? undeletableReason(p) : undefined}
                    style={{ background: COLORS.dangerSoft, color: COLORS.danger, border: "none", borderRadius: 6, padding: "5px 8px", cursor: isDeletable(p) ? "pointer" : "not-allowed", display: "flex", alignItems: "center", opacity: isDeletable(p) ? 1 : 0.5 }}
                  >
                    <Trash2 size={12} />
                  </button>
                </div>
