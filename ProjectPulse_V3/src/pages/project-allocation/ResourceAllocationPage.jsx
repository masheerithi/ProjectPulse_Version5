            ...
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <thead>
                <tr style={{ background: COLORS.bg }}>
                  ...
                  <th style={{ textAlign: "left", padding: "10px 16px", fontSize: 12, color: COLORS.textMuted, fontWeight: 700, textTransform: "uppercase", letterSpacing: 0.3 }}>Designation</th>
                  <th style={{ textAlign: "left", padding: "10px 16px", fontSize: 12, color: COLORS.textMuted, fontWeight: 700, textTransform: "uppercase", letterSpacing: 0.3 }}>Department</th>
                  ...
                  <th style={{ textAlign: "center", padding: "10px 16px", fontSize: 12, color: COLORS.textMuted, fontWeight: 700, textTransform: "uppercase", letterSpacing: 0.3 }}>Actions</th>
                </tr>
              </thead>
              <tbody>
                {loading ? (
                  ...
                  <tr key={a.id} style={{ borderTop: `1px solid ${COLORS.border}`, background: i % 2 ? "#FAFBFD" : "#fff" }}>
                    ...
                    <td style={{ padding: "11px 16px", fontSize: 13.5, color: COLORS.text }}>{findName(designations, a.designationId)}</td>
                    <td style={{ padding: "11px 16px", fontSize: 13.5, color: COLORS.text }}>{findName(departments, a.departmentId)}</td>
